    ...
    <section className="pt-10 mt-32 mx-auto w-full px-3 md:px-10">
      ...
      <div className="flex flex-col items-start justify-start text-start mb-20 mx-auto w-full">
        <div className="flex flex-col items-start justify-start max-w-7xl md:px-0 w-full">
          <div className="flex items-center gap-3 py-5 text-[#0C0C0CB0] text-sm md:text-sm text-nowrap font-neuehaaslight tracking-[2px]">
            <p>BRANDING</p>
      ...
      <div className="mt-6 w-full grid grid-cols-1 md:grid-cols-[480px,_1fr]">
        ...
        <div className="flex flex-col items-start">
          <h1 className="font-neuehaaslight font-medium text-2xl md:text-3xl">
          ...
          <div className="space-y-6 mt-6 mb-10">
            <div className="space-y-4 pb-12">
              <p className="text-base md:text-xl font-medium text-[#0C0C0CB0] font-neuehaaslight tracking-wide">
          ...
          <div className="space-y-6 mt-6">
            <div className="space-y-4 pb-12">
              ...
              <p className="text-base md:text-xl mt-4 font-medium text-[#0C0C0CB0] font-neuehaaslight tracking-wide">
          ...
          <div className="space-y-6 mt-6 mb-10">
            ...
            <div className="w-full pt-16 flex items-start">
              <div className="flex flex-col gap-3 items-start max-w-md">
                <p className="font-neuehaaslight uppercase text-[#0C0C0CB0]">Written by:</p>
                <div className="flex items-center gap-3">
                  <div className="">
                    <Link
                      href="https://www.linkedin.com/in/oke-omorohwovo-41089515b/"
                      className="font-neuehaasroman font-semibold text-xl"
                    >
                      Oke Omorohwovo
                    </Link>
                    <p className="text-[#0C0C0CB0] font-neuehaaslight">
                    COO & Partner, South Circle
                    </p>
                  </div>
                </div>
                <div className="md:hidden flex flex-col gap-2 mt-6">
                  <h2 className="text-base font-medium font-neuehaaslight uppercase text-[#0C0C0CB0] tracking-wider">
                    Share this news
                  </h2>
                  <div className="w-full flex items-center justify-between gap-2">
                    ...
                    >
                      <Image
                        ...
                        alt="X"
                      />
                      <p className="text-sm font-neuehaaslight pr-2">Twitter</p>
                    </button>
                    <button
                      onClick={() => openShareLink(linkedInUrl)}
                      className="p-2 md:p-4 border border-[#2d2d2d] rounded-full text-nowrap flex items-center justify-start w-fit gap-2 md:gap-4"
                    >
                      <Image
                        ...
                        alt="X"
                      />
                      <p className="text-sm font-neuehaaslight pr-2">
                        LinkedIn
                      </p>
                    </button>
                    <button
